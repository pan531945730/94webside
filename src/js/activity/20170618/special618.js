...
$(function() {
    ...
    require('../../../css/activity/20170618/special618.css');   
    //解锁
    var num = JSBK.Utils.GetQueryString('id') || '5', //哪一期
        acUnlock = $('.ac-unlock'),
    ...
    JSBK.shareWinxin({
        ...
        'link': 'http://np.94bank.com/Activity/Special61820170618',
        'imgUrl': window.Zepto.linkUrl+'/dist/Activity/img/20170618/special618/share.jpg'
    }) 
});