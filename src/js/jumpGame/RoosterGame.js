...
require('../../css/jumpGame/RoosterGame.css');
    ...
    * */
    ...
    window.game = {
        ...
        gameOverCallback: function(score) { //游戏结束
            ...
            $gameOver.find('.level').find('span').html(level(score));
        ...
        $.ajax({
            ...
            success: function (jdata) {
                if (jdata !== '' && jdata != null) {
                    ...
                    wxLink = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=wxfa162d899252d3f3&redirect_uri='+encodeURIComponent(link)+'&response_type=code&scope=snsapi_base&state=123&connect_redirect=1#wechat_redirect'
                    bk.shareWinxin({
                        'title': '玩游戏领百万年终奖！',
                        'desc': '1月26至1月30日，畅玩94鸡年步步高小游戏可获得超值年终奖，邀请好友福利再上一层楼，快来吧~',
                        'link': wxLink,
                        'imgUrl': 'http://img.94bank.com/np/dist/Activity/img/20170126/share-jumpgame.jpg'
                    });
                }
            }
        });
